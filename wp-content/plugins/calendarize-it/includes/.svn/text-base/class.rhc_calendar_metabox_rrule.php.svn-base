...
<div class="fc-dialog metabox-holder">
  ...
  <ul style="display:none;">
    <li id="prompt-remove">
      <?php _e('This will remove all calendarize date and recurring date settings.','rhc')?>
    </li>
    <li id="prompt-overwrite">
      <?php _e('This will overwrite all calendarize date and recurring date settings.','rhc')?>
    </li>
    <li id="prompt-allday">
      <?php _e('This is an all day event.','rhc')?>
    </li>
  </ul>
  ...
  <div id="fc-content-tabs" class="fc-widget postbox taxonomydiv">
      ...
      <div class="fc-dialog-content">
        ...
        <div class="tab-date tabs-panel">
          <div class="fc-form-field">
            <label for="fc_allday" class="left-label">
              <?php _e('All-day','rhc')?>
            </label>
          ...
          <div class="fc-form-field">
            ...
            <label for="fc_end" class="left-label">
              <?php _e('End','rhc')?>
            </label>
            <div class="fc-date-time">
          ...
          <div class="fc-form-field">
            <label for="fc_repeat" class="left-label">
              <?php _e('Repeat','rhc')?>
            </label>
          ...
          <div class="end-repeat-section">
            <div class="fc-form-field">
              ...
              <label for="fc_end_interval" class="left-label">
                <?php _e('End repeat','rhc')?>
              </label>
        ...
        <div class="tab-color tabs-panel">
          <h3>Event Color Code Key:</h3>
          <table style="margin-bottom:20px; width:100%; background:#f4f4f4;border:1px solid #DFDFDF; padding:5px;" cellpadding="5">
            <tr>
              <td align="left" width="50%" style="border-bottom: 1px solid #DFDFDF"><strong>WMS Masterworks</strong>:</td>
              <td align="right" style="border-bottom: 1px solid #DFDFDF"><span style="color:#F4078D">#F4078D</span></td>
            </tr>
            <tr>
              <td align="left" width="50%" style="border-bottom: 1px solid #DFDFDF"><strong>WMS Pops</strong>:</td>
              <td align="right" style="border-bottom: 1px solid #DFDFDF"><span style="color:#07CAF4">#07CAF4</span></td>
            </tr>
            <tr>
              <td align="left" width="50%" style="border-bottom: 1px solid #DFDFDF"><strong>Youth Symphony</strong>:</td>
              <td align="right" style="border-bottom: 1px solid #DFDFDF"><span style="color:#4EC90B">#4EC90B</span></td>
            </tr>
            <tr>
              <td align="left" width="50%" style="border-bottom: 1px solid #DFDFDF"><strong>Link Up</strong>:</td>
              <td align="right" style="border-bottom: 1px solid #DFDFDF"><span style="color:#FEAE02">#FEAE02</span></td>
            </tr>
            <tr>
              <td align="left" width="50%" style="border-bottom: 1px solid #DFDFDF"><strong>Olthoff Hall</strong>:</td>
              <td align="right" style="border-bottom: 1px solid #DFDFDF"><span style="color:#9000ff">#9000ff</span></td>
            </tr>
            <tr>
              <td align="left" width="50%"><strong>Text Color</strong>:</td>
              <td align="right"><span style="color:#484848">#484848</span></td>
            </tr>
          </table>
          <div class="fc-form-field">
            <label for="fc_color" class="left-label">
              <?php _e('Color','rhc')?>
            </label>
            <div class="farbtastic-holder">
              <input id="frm_fc_color" type='text' class='fc_color fc_input fc_color_input' name='fc_color' value='<?Php echo get_post_meta($post->ID,'fc_color',true)?>' />
              <a title="<?PHP _e('Choose color','rhc')?>" class="farbtastic-choosecolor" href="javascript:void(0);" rel="<?PHP _e('Close','rhc')?>">
              <?PHP _e('Show','rhc')?>
              </a>
          ...
          <div class="fc-form-field">
            <label for="fc_text_color" class="left-label">
              <?php _e('Text color','rhc')?>
            </label>
            <div class="farbtastic-holder">
              <input id="frm_fc_text_color" type='text' class='fc_text_color fc_input fc_color_input' name='fc_text_color' value='<?Php echo get_post_meta($post->ID,'fc_text_color',true)?>' />
              <a title="<?PHP _e('Choose color','rhc')?>" class="farbtastic-choosecolor" href="javascript:void(0);" rel="<?PHP _e('Close','rhc')?>">
              <?PHP _e('Show','rhc')?>
              </a>
        ...
        <div class="tab-calendar tabs-panel">
          <div class="fc-form-field">
            <label for="fc_click_link" class="left-label">
              <?php _e('Click links to','rhc')?>
            </label>
          ...
          <div class="fc-form-field">
            <label for="fc_click_target" class="left-label">
              <?php _e('Target','rhc')?>
            </label>
            <div class="fc-click-target">
              <select class="fc_click_target fc_input" name="fc_click_target">
                <option value="_blank">
                <?php _e('_blank new window or tab','rhc')?>
                </option>
                <option value="_self">
                <?php _e('_self same window or tab','rhc')?>
                </option>
              </select>
            </div>
            <div class="clear"></div>
        ...
        <div class="tab-rdate tabs-panel">
          <p>
            <?php _e('In addition to recurring rules you can set arbitrary repeat dates.','rhc')?>
          </p>
          <p>
            <?php _e('After adding the initial event simply click on any date in order to add the arbitrary repeat date.','rhc')?>
          </p>
          <div class="fc-form-field">
            <label for="fc_rdate" class="fullwidth-label">
              <?php _e('Repeat dates','rhc')?>
            </label>
            <p class="fc-no-rdate">
              <?php _e("No repeat dates set.")?>
            </p>
        ...
        <div class="tab-exdate tabs-panel">
          <p>
            <?php _e('Excluded dates are only applicable when using recurring events.','rhc')?>
          </p>
          <div class="fc-form-field">
            <label for="fc_exdate" class="fullwidth-label">
              <?php _e('Excluded dates','rhc')?>
            </label>
            <p class="fc-no-excluded">
              <?php _e("No excluded dates selected.  After setting up recurring events, click on a calendar event, then on the dialog press the exclude button to add the clicked date to the excluded dates list.")?>
            </p>
    ...
    <div class="fc-dialog-controls main-content">
      ...
      <div class="fc-status"> <img src="<?php echo admin_url('/images/wpspin_light.gif')?>" alt="" /> </div>
      <div class="clear"></div>
    </div>
    <div class="inside secondary-content">
      <p>
        <?php _e('In addition to recurring rules you can set arbitrary repeat dates.  Click accept to save an arbitrary repeat date.','rhc')?>
      </p>
      <p class="not-allday-input">
        <?php _e('The current calendarize settings require that you specify the repeat date time.','rhc')?>
      </p>
      <div class="secondary-content-fields">
        <div class="fc-form-field not-allday-input">
          <label for="fc_rdate" class="left-label">
            <?php _e('Repeat time','rhc')?>
          </label>
          <div class="fc-date-time">
            <input type="hidden" class="fc-selected-date-inp" value="" />
            <span class="fc-selected-date"></span><span class="fc-time-label">
            <?php _e('at','rhc')?>
            </span>
