...
<div class="venue-container custom-content-area">
	...
	<div class="venue-top-info">
		<div class="venue-small-map"><?php echo $use_dynamic_gmap?/*(get_gmap_shortcode_from_term_id($term_id,960,250)).*/do_shortcode(get_gmap_shortcode_from_term_id($term_id,960,250)):get_google_staticmap($term_id); ?></div>
		...
		<div class="venue-details-holder">
			...
			<div class="venue-defails">
				...
				<div class="venue-gaddress"><label class="tax-addres">Address</label><?php echo get_term_meta($term_id,'gaddress',true);?></div>
