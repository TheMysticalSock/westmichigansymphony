	...
	function options($t){
		...
		$t[$i]->options = array(
			...
			(object)array(
				...
				'label'		=> __('Template integration','wlb'),
				'type'		=> 'select',
				'default'	=> 'version2',
				'options'	=> array(
					'version1'	=> 'version 1',
			...
			(object)array(
				...
				'type' 			=> 'text',
				'label'			=> __('Event template page id','rhc'),
				'description'	=> sprintf('<p>%s</p><p>%s</p>',
					__('Specify the page id of the page you want to use as template for event pages and venues.','rhc'),
					__('Calendar widget: Specify a page id, to wich the calendar widget will link users.  Usually a page containing the calendarizeit shortcode.','rhc')
				),
				'save_option'=>true,
				'load_option'=>true
			),
			...
			(object)array(
				...
				'type' 			=> 'text',
				'label'			=> __('Venue and organizer template page id','rhc'),
				'save_option'=>true,
				'load_option'=>true
			),
			...
			(object)array(
				...
				'type' 			=> 'text',
				'label'			=> __('Calendar widget links to page id','rhc'),
				'save_option'=>true,
				'load_option'=>true
			),
			...
			(object)array(
				'id'		=> 'template_archive',
				'label'		=> __('Disable archive template','wlb'),
				'type'		=> 'yesno',
				'default'	=> '0',
				'el_properties'	=> array(),
				'save_option'=>true,
			...
			(object)array(
				'id'		=> 'template_single',
				'label'		=> __('Disable event template','wlb'),
				'type'		=> 'yesno',
				'default'	=> '0',
				'el_properties'	=> array(),
				'save_option'=>true,
			...
			(object)array(
				...
				'label'		=> __('Disable taxonomy template','wlb'),
				'type'		=> 'yesno',
				'default'	=> '0',
				'el_properties'	=> array(),
				'save_option'=>true,
			...
			(object)array(
				'id'		=> 'visibility_check',
				'label'		=> __('Check calendar visibility','wlb'),
				'type'		=> 'yesno',
				'default'	=> '0',
				'el_properties'	=> array(),
				'save_option'=>true,
		...
		$t[$i]->options = array(
			...
			(object)array(
				'id'		=> 'cal_alldayslot',
				'label'		=> __('Show all-day slot','wlb'),
				'type'		=> 'yesno',
				'default'	=> '1',
				'el_properties'	=> array(),
				'save_option'=>true,
			...
			(object)array(
				'id'	=> 'cal_mintime',
				'type'	=> 'range',
				'label'	=> __('Minimun displayed time','wlb'),
				'min'	=> 0,
				'max'	=> 24,
				'step'	=> 1,
				'default'=> 0,
			...
			(object)array(
				'id'	=> 'cal_maxtime',
				'type'	=> 'range',
				'label'	=> __('Maximun displayed time','wlb'),
				'min'	=> 0,
				'max'	=> 24,
				'step'	=> 1,
				'default'=> 24,
			...
			(object)array(
				'id'		=> 'cal_icalendar',
				'label'		=> __('Enable icalendar button','wlb'),
				'type'		=> 'yesno',
...
*/			
		...
		$t[$i]->options = array(
			...
			(object)array(
				'type'=>'subtitle',
				'label'=>__('Calendar month view','wlb')
			),			
			(object)array(
			...
			(object)array(
				'type'=>'subtitle',
				'label'=>__('Calendar week view','wlb')
			),				
			(object)array(
			...
			(object)array(
				'type'=>'subtitle',
				'label'=>__('Calendar day view','wlb')
			),					
			(object)array(
			...
			(object)array(
				'type'=>'subtitle',
				'label'=>__('Calendar event list view','wlb')
			),					
			(object)array(
			...
			(object)array(
				'type'=>'subtitle',
				'label'=>__('Event popup (click on calendar event)','wlb')
			),
			(object)array(
