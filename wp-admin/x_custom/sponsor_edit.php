...
$query_get_sponsor = sprintf("SELECT * FROM x_wp_extra_sponsor WHERE id = %s", GetSQLValueString($colname_get_sponsor, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE x_wp_extra_sponsor SET sponsor_name=%s, sponsor_url=%s, sponsor_image=%s WHERE id=%s",
