...
$query_get_image = sprintf("SELECT * FROM x_wp_extra_media_sponsor WHERE id = %s", GetSQLValueString($colname_get_image, "int"));
...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM x_wp_extra_media_sponsor WHERE id=%s",GetSQLValueString($_GET['id'], "int"));
