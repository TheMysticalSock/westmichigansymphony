...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM x_wp_extra_conductor WHERE id=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_x_wsso, $x_wsso);
  
$query_get_image = sprintf("SELECT * FROM x_wp_extra_conductor WHERE id = %s", GetSQLValueString($colname_get_image, "int"));
