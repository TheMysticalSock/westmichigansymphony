...
/*
mysql_select_db($database_x_wsso, $x_wsso); 
$query_get_media_query = "SELECT * FROM x_wp_extra_media_sponsor WHERE ex_id = '$colname_get_extra'";
$get_media_sponsor =  mysql_query( $query_get_media_query,$x_wsso) or die(mysql_error());
$row_get_media_sponsor = mysql_fetch_assoc($get_media_sponsor);
$totalRows_get_media_sponsor = mysql_num_rows($row_get_media_sponsor);
*/
...
$get_media_sponsor =  mysql_query( $query_get_media_query,$x_wsso) or die(mysql_error());
$row_get_media_sponsor = mysql_fetch_assoc($get_media_sponsor);
$totalRows_get_media_sponsor = mysql_num_rows($get_media_sponsor);
...
<tr>
    <td nowrap="nowrap">Media Sponsors</td>
    <td><a href="media_sponsor_add.php?post_id=<?=$colname_get_extra ?>">Add Media Sponsor</a></td>
    <td nowrap="nowrap">&nbsp;</td>
  </tr>
  <?php do { ?>
    <tr>
      <td nowrap="nowrap">&nbsp;</td>
      <td>
      <a href="<?php echo $row_get_media_sponsor['sponsor_url']; ?>"><img src="../../extra_images/<?php echo $row_get_media_sponsor['sponsor_image']; ?>" alt="<?php echo $row_get_sponsor['sponsor_name']; ?>"></a>
	  <?php echo $row_get_media_sponsor['sponsor_name']; ?> <?php echo $row_get_media_sponsor['sponsor_url']; ?> <?php echo $row_get_media_sponsor['sponsor_image']; ?></td>
      <td nowrap="nowrap"><a href="media_sponsor_delete.php?post_id=<?=$colname_get_extra ?>&id=<?=$row_get_media_sponsor['id'] ?>">Delete</a></td>
    </tr>
    <?php } while ($row_get_media_sponsor = mysql_fetch_assoc($get_media_sponsor)); ?>
